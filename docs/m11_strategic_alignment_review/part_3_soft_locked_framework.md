...
Purpose: Define how the project protects direction, quality, flexibility, and launch focus without becoming rigid or over-governed.
...
Used for things that should not change casually because they protect safety, trust, or validated behavior.
...
Deferred scope should be reviewed periodically, but not allowed to leak into active work without a deliberate decision.
...
test whether Discord membership gating can support Basic / Plus access without a website
...
- lead developer/architect provides structure, technical reasoning, and challenge
